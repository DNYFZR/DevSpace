...
class carbon_data:
    '''
        National Grid Carbon Intensity API caller. 
    '''
    def __init__(self, start_date, end_date, nation = 'Scotland'):
        self.start = start_date
        self.end = end_date
        self.nation = nation.title()
    ...
    def transform_data(self):
        ...
        # filter for only self.nation
        self.output = self.output[self.output['Name'] == self.nation].copy()
...
if __name__ == '__main__':
    ...
    start_date = dt.date(2022,4,12) 
    end_date = dt.date(2022,4,20)
